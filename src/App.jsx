          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="flex flex-col justify-between p-6 rounded-lg border border-gray-300 shadow-md">
                ...
                <p className="text-gray-600 mb-4">{t("home.guide.intro")}</p>
                <p className="text-gray-600 mb-4">{t("home.guide.details")}</p>
                <Link
                  to="/guide"
                  className="bg-purple text-black px-2 py-1 rounded-md hover:bg-opacity-90 self-start"
                >
                  {t("home.getStarted")}
                </Link>
              </div>
              <div className="flex flex-col justify-between p-6 rounded-lg border border-gray-300 shadow-md">
                ...
                <p className="text-gray-600 mb-4">{t("home.training.intro")}</p>
