      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="mb-6">
            <Link
              to="/training"
              className="text-dark-purple hover:underline mb-4 inline-block"
            >
              ← Back to Training Modules
            </Link>
            <h1 className="text-3xl font-bold text-custom-black mt-4">
              {module.title}
            </h1>
            ...
            {module.modules.map((subModule) => (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <span
                    className={`text-sm ${
                      subModule.completed ? "text-green-600" : "text-gray-500"
                    }`}
                  >
