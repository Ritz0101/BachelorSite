      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="mb-6">
            ...
            <h1 className="text-3xl font-bold text-black mt-4">{t('information_classification_basics_title')}</h1>
            <p className="text-black mt-2">{t('information_classification_basics_description')}</p>
          ...
          <div className="space-y-6 mt-8">
            ...
            >
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-xl font-semibold text-black">{t('understanding_security_levels_title')}</h3>
                  <p className="text-black mt-2">{t('understanding_security_levels_description')}</p>
                </div>
            ...
            >
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-xl font-semibold text-black">{t('identifying_sensitive_information_title')}</h3>
                  <p className="text-black mt-2">{t('identifying_sensitive_information_description')}</p>
                </div>
            ...
            >
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-xl font-semibold text-black">{t('handling_classified_information_title')}</h3>
                  <p className="text-black mt-2">{t('handling_classified_information_description')}</p>
                </div>
