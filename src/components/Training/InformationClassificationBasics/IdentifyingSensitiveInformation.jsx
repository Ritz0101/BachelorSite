    ...
    <div className="min-h-screen bg-light-purple pt-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <h1 className="text-3xl font-bold text-custom-black mb-4">Identifying Sensitive Information</h1>
          
          <div className="space-y-8 mt-6">
            <section>
              <h2 className="text-2xl font-semibold text-custom-black mb-3">Course Overview</h2>
              <p className="text-gray-600 mb-4">
                This course teaches you how to identify different types of sensitive information and
                determine appropriate classification levels based on their nature and potential impact.
              </p>
            </section>
