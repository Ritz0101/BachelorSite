      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <div className="flex flex-wrap gap-3 mt-4">
            <span className="px-3 py-1 bg-purple rounded-full text-gray-800 font-medium transition-transform transition-shadow cursor-default hover:scale-[1.02] hover:shadow-md">{t('technologies_react_title')}</span>
            <span className="px-3 py-1 bg-purple rounded-full text-gray-800 font-medium transition-transform transition-shadow cursor-default hover:scale-[1.02] hover:shadow-md">{t('technologies_tailwind_title')}</span>
            <span className="px-3 py-1 bg-purple rounded-full text-gray-800 font-medium transition-transform transition-shadow cursor-default hover:scale-[1.02] hover:shadow-md">{t('technologies_javascript_title')}</span>
            <span className="px-3 py-1 bg-purple rounded-full text-gray-800 font-medium transition-transform transition-shadow cursor-default hover:scale-[1.02] hover:shadow-md">{t('technologies_Vite_title')}</span>
            <span className="px-3 py-1 bg-purple rounded-full text-gray-800 font-medium transition-transform transition-shadow cursor-default hover:scale-[1.02] hover:shadow-md">{t('technologies_router_title')}</span>
          </div>
